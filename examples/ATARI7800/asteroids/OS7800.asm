...
*
*
*   7800 One-on-One Basketball needs some ram initialized to $ff (for shame!!!)
*
*
*  Now make One-on-One Basketball happy
*
	lda	#$ff
	ldx	#$3f
framlp:
	...
	bpl	framlp
*
*   Now load up some dumb display list in case maria needs some practice
*
	ldx	#9
fakeload:
	lda	fakelist,x
...
fakeinc:
	...
	bne	fakeinc
*
	jmp	ramcode+(CARTTEST-ROMCODE)	;jump in at CARTTEST
*
*
...
NOCART:
	...
	JMP	ASTEROID		;NO CART, do asteroids
*
CARTTEST:
...
SETMARIA:
	lda	#02
	sta	PTCTRL		;turn on internal rom (for NMI processing)
*
	jsr	ramcode+(wait00-ROMCODE)	;wait for V-blank start
*
	lda	#$27		;install our practice zone list
	sta	DPPH
	lda	#07
	sta	DPPL
*
	lda	#$43
	sta	NMICTRL		;tell ASTEROIDS nmi routine to do nothing 
	sta	CTRL		;turn maria on in 320 mode
*
	ldx	#1
frame2:
	jsr	ramcode+(wait00-ROMCODE)	;wait for V-blank start
	dex			;do 2 frames of this stuff
	bpl	frame2
*
	lda	#$60
	sta	CTRL		;turn maria off
*
...
*
*
*   This is a 7800 wait-for-beginning-of V-blank routine
*
wait00:
	bit	MSTAT
	bmi	wait00
...
HSCTAB:
	...
	.byte	$4F,$68,$21,$20,$57,$68,$61,$74,$20,$61
	.byte	$20,$66,$69,$6E,$65,$20,$62,$6F,$79,$20   
	.byte	$69,$73,$20,$44,$61,$76,$65,$20,$53,$74   
	.byte	$61,$75,$67,$61,$73,$2E           
