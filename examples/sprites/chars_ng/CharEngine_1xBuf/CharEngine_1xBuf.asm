...
; - tylko jeden bufor dla pamięci obrazu, możliwe jest w nim użycie znaków 0..75
...
; - stałe wartości kodów znaków dla reprezentacji duchów rozpoczynające się od znaku 76
...
; znaki 124, 125, 126, 127 nie są używane m.in. w celu ochrony obszaru $fff8..$ffff (dla zestawu $fc00..$ffff)
; każde 4 znaki muszą mieścić się w granicy strony pamięći
...
uB1	@sprite_backup B1 0		; licz nową klatkę ducha na nowej pozycji X:Y
	...
	jsr Playfield_Update		; procedura użytkownika aktualizaująca pole gry
