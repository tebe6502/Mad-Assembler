...
inf3 dta d'SPACE-play  ESC-exiÙ'
s_pl dta d' samples-'
memo dta d'No memor˘'
...
inf2 dta d'-move cursor  RETURN-loa‰'
inf1 dta d'SPACE-director˘'
erro dta d'ErroÚ'
...
patt dta d'patterns-'
trck dta d'  tracks-'
much dta d'Only 48 patternÛ'
vali dta d'Valid MOD filÂ'
tmod dta c'DO'
title dta c'M.K.'
...
obr dta d'âïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïè'
 dta d'INERTIA ver 3.7 by Madteam ',b(7),d'96ô'
 dta d'ãå'
ekran dta d'                              ô'
 dta d'                              ô'
 dta d'                              ô'
...
cfg dta d'-change configuratioÓ'
xms dta d'I need extra memor˘'
