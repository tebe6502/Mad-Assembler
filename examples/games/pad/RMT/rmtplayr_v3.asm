...
;================================================================================
	...
	icl "RMT/ark_2a_feat.asm"

;================================================================================
; RMT ZeroPage addresses
;================================================================================
	org RMT_vars_address
...
; HACK: I don't want this init (because I am using IRQ's)
	lda #0
	sta $d208
	ldy #3
	sty $d20f
...
; .if .def IRQ_15KHz
; 	lda #1		; 15khz mode (force this clock)
; 	sta $d208
; 
; 	lda #0
; 	sta $d200
...
; 	sta $d205
; .else
; 	lda #64		; channel 1 at 1.79MHz (force this clock)
; 	sta $d208
; 
; 	lda #0
; 	sta $d202
...
; 	tya
; .if .def IRQ_15KHz
; 	ora #1			; force 15KHz clock
; .else
; 	ora #1+64			; force 15KHz clock, force first voice in 1.79MHz
; .endif
; 	tay
