...
_Color0  =     $D6 ; Colors loaded from ColorTbl for player 0 and 1
_Color1  =     $D7 ; These may be changed e.g. invisible tanks
...
;        thru $E7 ; lo nibble 0, lo 1, hi 0, hi 1
COLcount =    $E8 ; Counter keeps tank-tank and tank-PF collisions from
;        thru $E9 ; affecting a stationary tank's bearing unless the
...
missile1_collmask = $f6
player1_collmask = $f7
player0_collmask = $f8
player1a_collmask = $f9
...
XPOS_MISSILE_ADJUST = 4
YPOS_ADJUST = -4
YPOS_MISSILE_ADJUST = 7
INITIAL_YPOS_TANK_PLANE0 = 134 + YPOS_ADJUST
INITIAL_YPOS_PLANE1 = 50 + YPOS_ADJUST

YPOS_EXIT_TOP = $25
YPOS_ENTRY_TOP = $28
YPOS_EXIT_BOTTOM = $DB
YPOS_ENTRY_BOTTOM = $D9
...
.macro _PFROW
		dta		[[[:1]&$10]!=0]*$40+[[[:1]&$20]!=0]*$10+[[[:1]&$40]!=0]*$04+[[[:1]&$80]!=0]*$01
		dta		[[[:2]&$80]!=0]*$40+[[[:2]&$40]!=0]*$10+[[[:2]&$20]!=0]*$04+[[[:2]&$10]!=0]*$01
		dta		[[[:2]&$08]!=0]*$40+[[[:2]&$04]!=0]*$10+[[[:2]&$02]!=0]*$04+[[[:2]&$01]!=0]*$01
		dta		[[[:3]&$01]!=0]*$40+[[[:3]&$02]!=0]*$10+[[[:3]&$04]!=0]*$04+[[[:3]&$08]!=0]*$01
		dta		[[[:3]&$10]!=0]*$40+[[[:3]&$20]!=0]*$10+[[[:3]&$40]!=0]*$04+[[[:3]&$80]!=0]*$01
		dta		[[[:3]&$80]!=0]*$40+[[[:3]&$40]!=0]*$10+[[[:3]&$20]!=0]*$04+[[[:3]&$10]!=0]*$01
		dta		[[[:3]&$08]!=0]*$40+[[[:3]&$04]!=0]*$10+[[[:3]&$02]!=0]*$04+[[[:3]&$01]!=0]*$01
		dta		[[[:2]&$01]!=0]*$40+[[[:2]&$02]!=0]*$10+[[[:2]&$04]!=0]*$04+[[[:2]&$08]!=0]*$01
		dta		[[[:2]&$10]!=0]*$40+[[[:2]&$20]!=0]*$10+[[[:2]&$40]!=0]*$04+[[[:2]&$80]!=0]*$01
		dta		[[[:1]&$80]!=0]*$40+[[[:1]&$40]!=0]*$10+[[[:1]&$20]!=0]*$04+[[[:1]&$10]!=0]*$01
.endm

		org		$2500
		.pages 1
dlist_complex:
		dta		$48,a(playfield0_0)
		:11 dta $08
		dta		$48,a(playfield0_11)
		dta		$48,a(playfield0_9)
		dta		$08
		dta		$48,a(playfield0_8)
		dta		$48,a(playfield0_7)
		dta		$48,a(playfield0_6)
		dta		$48,a(playfield0_5)
		dta		$48,a(playfield0_4)
		dta		$48,a(playfield0_3)
		dta		$48,a(playfield0_1)
		dta		$08
		dta		$48,a(playfield0_0)
		dta		$41,a(dlist)
...
dlist_clouds:
		:9 dta $70
		dta		$48,a(playfield3_9)
		dta		$08
		dta		$08
		dta		$48,a(playfield3_11)
		dta		$48,a(playfield3_10)
		dta		$48,a(playfield3_9)
		:9 dta $70
		dta		$41,a(dlist)
...
dlist_blank:
		...
		;Combat uses a 205 line tall active region, which is a bit more than a usual
		;A8 display. The top is a little more important than the bottom, so place it
		;slightly lower than usual.
dlist:
		dta		$70,$50
		dta		$47,a(score_playfield)
		dta		$20
		dta		$01,a(dlist_simple)
dlist_sel = *-2
		dta		$41,a(dlist)

playfield0_0	_PFROW	$F0,$FF,$FF
playfield0_1	_PFROW	$10,$00,$80
playfield0_2	_PFROW	$10,$00,$80
playfield0_3	_PFROW	$10,$00,$00
playfield0_4	_PFROW	$10,$38,$00
playfield0_5	_PFROW	$10,$00,$00
playfield0_6	_PFROW	$10,$00,$1C
playfield0_7	_PFROW	$10,$00,$04
playfield0_8	_PFROW	$10,$60,$00
playfield0_9	_PFROW	$10,$20,$00
playfield0_10	_PFROW	$10,$20,$00
playfield0_11	_PFROW	$10,$23,$00

playfield1_0	_PFROW	$F0,$FF,$FF
playfield1_1
playfield1_2
playfield1_3
playfield1_4
...
playfield1_9
playfield1_10
playfield1_11	_PFROW	$10,$00,$00

playfield2_0	_PFROW	$F0,$FF,$FF
playfield2_1	_PFROW	$10,$00,$00
playfield2_2	_PFROW	$10,$00,$00
playfield2_3	_PFROW	$10,$00,$00
playfield2_4	_PFROW	$10,$00,$80
playfield2_5	_PFROW	$10,$00,$80
playfield2_6	_PFROW	$10,$00,$80
playfield2_7	_PFROW	$10,$00,$80
playfield2_8	_PFROW	$10,$00,$00
playfield2_9	_PFROW	$10,$60,$00
playfield2_10	_PFROW	$10,$20,$00
playfield2_11	_PFROW	$10,$21,$07

playfield3_9	_PFROW	$00,$07,$07
playfield3_10	_PFROW	$00,$1F,$1F
playfield3_11	_PFROW	$00,$3F,$3F
...
charmap:
		...
		;digit lefts
		dta		$00,$00,$00,$FF,$F0,$F0,$F0,$FF
		dta		$00,$00,$00,$00,$00,$00,$00,$00
		dta		$00,$00,$00,$FF,$00,$FF,$F0,$FF
		dta		$00,$00,$00,$FF,$00,$0F,$00,$FF
		dta		$00,$00,$00,$F0,$F0,$FF,$00,$00
		dta		$00,$00,$00,$FF,$F0,$FF,$00,$FF
		dta		$00,$00,$00,$FF,$F0,$FF,$F0,$FF
		dta		$00,$00,$00,$FF,$00,$00,$00,$00
		dta		$00,$00,$00,$FF,$F0,$FF,$F0,$FF
		dta		$00,$00,$00,$FF,$F0,$FF,$00,$FF

		;digit rights
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$00,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$00,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$00,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
		dta		$00,$00,$00,$F0,$F0,$F0,$F0,$F0
...
main_loop:
	...
	;
		...
		INC  CLOCK            ; Master frame count timer
...
.proc DrawPlayers
		...
		:8 sta sprite_p3+#,x
		ldx		erasem0_vpos
		sta		sprite_m+YPOS_MISSILE_ADJUST,x
		ldx		erasem1_vpos
		sta		sprite_m+YPOS_MISSILE_ADJUST,x
		...
		sta		sprite_m+YPOS_MISSILE_ADJUST,x
		lda		#$a8
		ora		sprite_m+YPOS_MISSILE_ADJUST,y
		sta		sprite_m+YPOS_MISSILE_ADJUST,y
...
finish:
		...
		lsr
		lda		#0
		scc:lda	vdelayp0_tab,y
		tax
		lda		TankY1
		lsr
		txa
		scc:ora	vdelayp1_tab,y
		tax
		lda		MissileY0
		lsr
		txa
		scc:ora	vdelaym0_tab,y
		tax
		lda		MissileY1
		lsr
		txa
		scc:ora	vdelaym1_tab,y
		sta		vdelay
		rts
...
setup_missiles:
		...
		lda		#1
		bit		resmp0
		seq:ldx	#<[0-YPOS_MISSILE_ADJUST]
		bit		resmp1
		seq:ldy	#<[0-YPOS_MISSILE_ADJUST]
		rts

		;Tables for: 1v1, 2v2, 1v3, Bv3
hposp1_src		dta		player0_hpos,player0_hpos,player1_hpos,player1_hpos
hposp1_mask		dta		$00,$ff,$ff,$ff
hposp1_offset	dta		$00,$10,$10,$10

hposp2_src		dta		player0_hpos,player1_hpos,player1_hpos,player1_hpos
hposp2_mask		dta		$00,$ff,$ff,$ff
hposp2_offset	dta		$00,$10,$20,$20

sizep0_table	dta		$00,$00,$00,$03

vdelayp0_tab		dta		$30,$30,$10,$10
vdelayp1_tab		dta		$C0,$C0,$E0,$E0
vdelaym0_tab		dta		$03,$03,$01,$01
vdelaym1_tab		dta		$0C,$0C,$0E,$0E
.endp
...
;
VOUT
		STA  hitclr              ; Clear collision latches
		LDA  KLskip
		...
		mva		scroff+0	score_playfield+2
		mva		scroff+2	score_playfield+3
		mva		scroff+4	score_playfield+4
		mva		scroff+6	score_playfield+5
		mva		scroff+1	score_playfield+12
		mva		scroff+3	score_playfield+13
		mva		scroff+5	score_playfield+14
		mva		scroff+7	score_playfield+15
		jmp		Vmain
...
ResetField 
	...
	;
	LDA  #INITIAL_YPOS_PLANE1
	STA  TankY1
	LDA  #INITIAL_YPOS_TANK_PLANE0
	STA  TankY0
...
PhNoTank
	CMP  #YPOS_EXIT_BOTTOM              ; Perform vertical wrap-around
	BCS  PhNoWrapTop        ; branch if over top (wrap)
	CMP  #YPOS_EXIT_TOP
	BCS  PhNoWrap           ; branch if over bottom (no wrap)
PhNoWrapTop
	LDA  #YPOS_ENTRY_BOTTOM  ; Assume we wrapped bottom to top
	BIT  $D4                ; Meaning offset was negative
	BMI  PhNoWrap
	LDA  #YPOS_ENTRY_TOP               ; Otherwise, we wrapped top to bottom
PhNoWrap
...
NoStirRush
	...
	LSR                     ; 
BoomSnd	STA  _audv0,X            ; Set explosion sound to volume in A
...
ResRTS
		cmp		resmp0,x
		beq		no_reset
		STA		RESMP0,X           ; to player.

		cmp		#0
		bne		no_reset
		lda		player0_hpos,x
		adc		#XPOS_MISSILE_ADJUST-1

		;need to add another 2ccks if player 0 is wide
		ldy		nusiz0,x
		cpy		#$27
		sne:adc	#2
...
DOMOTOR	LDY  GAMSHP
	...
	STA  _audv0,X            ; volume value w/$00 no-game value
	LDA  SNDC,Y
	STA  _audc0,X
	CLC  
	LDA  #$00
...
.proc COLIS
		;read collision masks for all missiles and build a missile
		;hit player mask
		;
		; M0 - hits P1 only
		; M1 - hits P0 or P0 depending on mode
		; M2 - hits P0 only
		; M3 - hits P0 only

		lda		m0pl
		and		player1_collmask
		sta		mxpl_coll
		lda		m2pl
		ora		m3pl
		and		player0_collmask
		ora		mxpl_coll
		sta		mxpl_coll
		lda		m1pl
		and		missile1_collmask
		ora		mxpl_coll
		sta		mxpl_coll
		...
		;compute player-player collisions
		lda		p1pl
		and		missile1_collmask
		ora		p3pl
		ora		p2pl
		...
		LDX		#$01               ; Do first for P1, DEX, P0, etc.
COLnext:
		lda		mxpl_coll
		and		player1_collmask,x
		beq		COLnoHit           ; No missile collision
...
COLDET	INC  DIRECTN,X  ; Turn both tanks 22.5 degrees.
	...
	STA  RESMP1
	LDA  #$00
	STA  _audv0,X          ; Turn off the victor's engine.
...
COLTNK	LDA  AltSnd,X
	...
	STA  AltSnd,X
COLnoAlt
		;check for missile-playfield collision
		lda		player0_collmask,x
		bit		mxpf_coll
		bne		COLMPF             ; If true, bounce or obliterate...
	LDA  #$00
...
COLTCK
		lda		pxpf_coll
		and		player0_collmask,x
		bne		COLTW              ; check if tank collided with a wall.

		;check for a tank-tank collision
		lda		pxpl_coll
		beq		COLTCLR            ; branch if NO tank collisions at all
...
LDmult	ASL   
	...
	lsr
	tax
	lda		player0_collmasks,x
	sta		player0_collmask
	lda		player1_collmasks,x
	sta		player1_collmask
	sta		player1a_collmask
	lda		missile1_collmasks,x
	sta		missile1_collmask
...
LDcol0	LDA		ColorTbl,Y
		...
		STA		_Color0,X           ; Color the virtual item.  This can
...
missile0_collpfindexes:
		dta		0,0,0,0
		dta		0,1,0,0
		dta		0,0,0,0
		dta		0,1,0,0

missile1_collpfindexes:
		dta		3,2,1,1
		dta		3,3,1,1
		dta		3,2,2,2
		dta		3,3,3,3
...
;
ColorTbl
		dta		$EA ,$3C ,$82 ,$44      ; 00 = Regular Tanks
		dta		$32 ,$2C ,$8A ,$DA      ; 01 = Tank Pong
		dta		$80 ,$9C ,$DA ,$3A      ; 10 = Jets
		dta		$64 ,$A8 ,$DA ,$4A      ; 11 = Biplanes
		dta		$08 ,$04 ,$00 ,$0E      ; special B&W
...
SPRLO	dta		<TankShape, <PlaneShape, <JetShape
SPRHI	dta		>TankShape, >PlaneShape, >JetShape
...
;
	;        Complex   ,    None 
	;        Simple    ,   Clouds
PLFPNT	dta		<(PF0_0-4), <(PF0_0-4)
		dta		<(PF0_0-4), <(PF0_3-4)   ;PF0
		dta		<(PF1_0-4), <(PF1_1-4)
		dta		<(PF1_2-4), <(PF1_3-4)   ;PF1
		dta		<(PF2_0-4), <(PF1_1-4)
		dta		<(PF2_2-4), <(PF1_3-4)   ;PF2
